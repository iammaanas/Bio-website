/* ═══════════════════════════════════════════════════════════════════
   ...
   HAMAKER REFERENCE (per-seta, informational):
     ...
     → F_seta ≈ 200 nN  (Autumn et al., Nature 2000, doi:10.1038/35079073)
...
═══════════════════════════════════════════════════════════════════ */
// Constants centralised in: js/physics_constants.js
// Values below match GeckoPhysics constants exactly.
